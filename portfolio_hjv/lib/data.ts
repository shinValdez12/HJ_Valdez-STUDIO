...
export const projects: Project[] = [
  ...
  },
  {
    ...
    slug: "echo-music",
    title: "Echo Music",
    shortDescription: "AI-powered music streaming with personalized experiences",
    fullDescription: "Echo reimagines music streaming with AI-driven curation, spatial audio, and social listening features. The interface adapts to user mood and context.",
    image: "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=1200&h=800&fit=crop",
    category: "web",
    techStack: ["Next.js", "TypeScript", "Web Audio API", "TensorFlow.js", "Prisma"],
    role: "Full-Stack Developer",
    challenges: "Building a responsive audio player with seamless transitions and real-time audio visualization.",
    solution: "Created a custom audio engine with precise timing control, implemented efficient audio analysis using Web Workers.",
    liveUrl: "https://echo-music.vercel.app",
    featured: false,
  },
  {
    id: "5",
