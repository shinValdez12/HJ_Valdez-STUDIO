    ...
    <div className="flex flex-col gap-0 pb-28">
      ...
      <div className="px-4 flex flex-col gap-3">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand-yellow to-brand-yellow-dark p-5">
          ...
          <div className="flex items-center gap-4 relative">
            ...
            <div>
              ...
              <p className="text-gray-700 text-xs">₱{hourlyRate}/hr</p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center py-2">
          <p className="text-xs text-gray-400 dark:text-gray-500">CrewTime v1.0.0</p>
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Data stored locally on your device</p>
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Made by HJ.Valdez</p>
        </div>
      </div>
    </div>
  );
