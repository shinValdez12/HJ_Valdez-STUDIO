          ...
          <Card className="border-2 border-dashed border-brand-red/30 bg-brand-red/5 dark:bg-brand-red/10">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">Add your name, role, and employee ID</p>
              </div>
          ...
          <div className="relative">
            ...
            <div className="flex items-center gap-4 mt-3">
              <div>
                ...
                <p className="text-white text-sm font-semibold">{summary.totalRegularHours.toFixed(1)}h</p>
              </div>
              ...
              <div className="w-px h-6 bg-white/20" />
              <div>
                <p className="text-white/60 text-[10px]">Night Diff</p>
                <p className="text-white text-sm font-semibold">{summary.totalNightDiffHours.toFixed(1)}h</p>
              </div>
              <div className="w-px h-6 bg-white/20" />
              <div>
